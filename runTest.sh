...
if [ $x -eq 1 ] 
then java EarthSim.Demo -b$b > results.txt
elif [ $x -eq 2 ] 
then java EarthSim.Demo -s -p -b$b > results.txt
elif [ $x -eq 3 ] 
then java EarthSim.Demo -t -b$b > results.txt
elif [ $x -eq 4 ] 
then java EarthSim.Demo -s -p -t -b$b > results.txt
elif [ $x -eq 5 ] 
then java EarthSim.Demo -r -b$b > results.txt
elif [ $x -eq 6 ] 
then java EarthSim.Demo -s -p -r -b$b > results.txt
fi
